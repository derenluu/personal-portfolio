...
export const Data = {
  ...
  portfolio: {
      ...
      experience: [
        {
          ...
          description: [
            'Monitor operation system of chips.',
            'Activity threading of chips.',
            'Investigate and take part in the process of making of chips.',
          ],
        },
        {
          title: 'Web Developer',
          ...
          time: '12/2021 - Now',
          description: [
            'Learn about production processes including various separate production processes from many departments.',
            'Process data from documents like Excel, PDF,...',
            'Choose suitable technologies to present the required information.',
            'Learn new technology and generate creative ideas to build a website.',
          ],
        },
      ],
      project: {
    ...
    achievements: {
      certificates: [
        'Certificate of English at school (A2).',
        'Certificate of Informatics at the school.',
        'Certificate of IOT at school (8/10).',
      ],
      activities: [
